...
class Validation:
    ...
    def validate_words(self, word_graph: nx.Graph, start_word: str, end_word: str) -> Validation:
        return self.validate_word(start_word, word_graph).validate_word(end_word, word_graph)
